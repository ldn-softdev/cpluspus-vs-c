> You probably get on this page from [jtc](https://github.com/ldn-softdev/jtc#programming-model), where I make quite a bold statement about `C` and `C++`. This articale hopefully will clarify what _I_ meant.
